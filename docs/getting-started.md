...
It exists 4 types of files used by **Architect software** :
...
<table>
        ...
        <tr>
            <td>.ALIAS</td>
            <td>This file is a text file, cused for the communication between Architect and a PLC.</td>
        </tr>
        <tr>
            <td>.CONFIG</td>
...
After openning **Architect software**, Click on **File** > **Open**.  
